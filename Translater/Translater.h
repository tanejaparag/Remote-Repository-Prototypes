...
// ver 1.1                                                             //
// Author - Parag , CSE 687 , OOD , Spring 2018
...
*  
*Public Function
void Translater::close() - close Client comm instance which stops listener and receiver
void Translater::listen(CsEndPoint^ ep) - set client listen endpoint and start Comm
CsMessage^ Translater::fromMessage(Message& msg) - convert native message to managed message
inline void Translater::postMessage(CsMessage^ csMsg) - use Comm to post message
...
* ----------------------
* ver 1.1 : 4/8/2018
*	- Added stop function to delete clients Comm
*  ver 1.0 : 3/27/2018
*  - first release
*/
...
namespace MsgPassingCommunication
{
  ...
  //----< close Client comm instance which stops listener and receiver>----
 void Translater::close()
  {
	  std::cout << "\n using CommFactory to close and delete the instance of Comm from native heap";
	  pComm->stop();
	  std::cout << "\n using CommFactory to close and delete the instance of Comm from native heap";
	  delete pComm;
